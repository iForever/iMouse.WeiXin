...
{
    public interface IWebAuthorizeService
    {
        /// <summary>
        /// 获取网页授权引导URL
        /// </summary>
        ...
        /// <returns></returns>
        Task<Code2WebAccessTokenResponse?> Code2WebAccessTokenAsync(Code2WebAccessTokenRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<GetScopeUserInfoResponse?> GetScopeUserInfoAsync(GetScopeUserInfoRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CheckWebAccessTokenResponse?> CheckWebAccessTokenAsync(CheckWebAccessTokenRequest request);
    }
