...
{
    public class GenerateUrlLinkRequest : BaseTokenRequest
    {
        [JsonIgnore]
        internal override HttpMethod RequestMethod => HttpMethod.Post;

        [JsonProperty]
        internal override string Endpoint => "/wxa/generate_urllink";
    ...
    public class GenerateUrlLinkResponse : BaseResponse
    {
        /// <summary>
        /// 生成的小程序 URL Link
        /// </summary>
